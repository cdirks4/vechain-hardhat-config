...
export type { ShoeRegistry } from "./contracts/ShoeRegistry.test.sol/ShoeRegistry";
export { ShoeRegistry__factory } from "./factories/contracts/ShoeRegistry.test.sol/ShoeRegistry__factory";
